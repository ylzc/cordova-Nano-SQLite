...
;
var _SQLiteStore = (function () {
    function _SQLiteStore(size) {
        this._pkKey = {};
        this._pkType = {};
        this._dbIndex = {};
        this._size = (size || 0) * 1000 * 1000;
    }
    _SQLiteStore.prototype.setID = function (id) {
        this._id = id;
    };
    _SQLiteStore.prototype.connect = function (complete) {
        var _this = this;
    ...
    _SQLiteStore.prototype._chkTable = function (table) {
    ...
    _SQLiteStore.prototype.makeTable = function (tableName, dataModels) {
        var _this = this;
    ...
    _SQLiteStore.prototype._sql = function (allowWrite, sql, args, complete) {
    ...
    _SQLiteStore.prototype.write = function (table, pk, data, complete, skipReadBeforeWrite) {
        var _this = this;
    ...
    _SQLiteStore.prototype.delete = function (table, pk, complete) {
    ...
    _SQLiteStore.prototype.read = function (table, pk, callback) {
    ...
    _SQLiteStore.prototype.rangeRead = function (table, rowCallback, complete, from, to, usePK) {
        var _this = this;
    ...
    _SQLiteStore.prototype.drop = function (table, callback) {
    ...
    _SQLiteStore.prototype.getIndex = function (table, getLength, complete) {
        complete(getLength ? this._dbIndex[table].keys().length : this._dbIndex[table].keys());
    };
    _SQLiteStore.prototype.destroy = function (complete) {
        var _this = this;
...
exports._SQLiteStore = _SQLiteStore;
